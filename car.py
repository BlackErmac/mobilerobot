...
class Car:
	...
	def __init__(self, x, y):
		# first position defination
		self.x = np.array([
							[x],
							[y],
							[0]
						  ])
		# first velocity defination
		self.x_dot = np.array([
							[0],
							[0],
							[0]
						  ])
		# fist wheels velocity
		self.wheel_speed = np.array([
										[0],
										[0]
									])

		# b = width of the car & r = width of the wheel
		self.b = 25
		self.r = 5

		# car dimensions defination
	...
	# apply changes for wheel velocity
	...
	# apply changes for robot velocity
